...
// ------------------------------------------
  ...
  for ($i = 1; $i <= 12; $i = $i + 1)
  {
    ...
    imagettftext($im, 14, 0, $xy[0] + $center_pt, $xy[1] + $center_pt, $clr_to_use, dirname(__FILE__) . '/HamburgSymbols.ttf', chr($sign_glyph[$sign_pos]));
    ...
    imagettftext($im, 10, 0, $xy[0] + $center_pt, $xy[1] + $center_pt, $black, dirname(__FILE__) . '/arial.ttf', $t . chr(176));
    ...
    imagettftext($im, 10, 0, $xy[0] + $center_pt, $xy[1] + $center_pt, $black, dirname(__FILE__) . '/arial.ttf', $t . chr(39));
  }
...
// ------------------------------------------
  ...
  for ($i = 1; $i <= 12; $i = $i + 1)
  {
    ...
    imagettftext($im, 10, 0, $xy[0] + $center_pt, $xy[1] + $center_pt, $black, dirname(__FILE__) . '/arial.ttf', $i);
  }
...
// ------------------------------------------
  ...
  for ($i = $num_planets - 1; $i >= 0; $i--)
  {
    ...
    imagettftext($im, 16, 0, $xy[0] + $center_pt, $xy[1] + $center_pt, $planet_color, dirname(__FILE__) . '/HamburgSymbols.ttf', chr($pl_glyph[$sort_pos[$i]]));
    ...
    imagettftext($im, 10, 0, $xy[0] + $center_pt, $xy[1] + $center_pt, $planet_color, dirname(__FILE__) . '/arial.ttf', $t . chr(176));
    ...
    imagettftext($im, 10, 0, $xy[0] + $center_pt, $xy[1] + $center_pt, $clr_to_use, dirname(__FILE__) . '/HamburgSymbols.ttf', chr($sign_glyph[$sign_pos]));
    ...
    imagettftext($im, 10, 0, $xy[0] + $center_pt, $xy[1] + $center_pt, $planet_color, dirname(__FILE__) . '/arial.ttf', $t . chr(39));
    ...
    if (strtoupper(mid($retrograde, $sort_pos[$i] + 1, 1)) == "R")
    {
      ...
      imagettftext($im, 10, 0, $xy[0] + $center_pt, $xy[1] + $center_pt, $red, dirname(__FILE__) . '/HamburgSymbols.ttf', chr(62));
    }
  }
