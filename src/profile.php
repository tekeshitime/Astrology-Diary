...
<div class="max-w-screen-md mx-auto p-4 md:p-8">
  ...
  <div class="">
    <div class="inline-flex rounded-md">
      <a href="profile_edit" class="px-4 py-2 text-sm font-medium text-white bg-gray-300 border border-gray-200 rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">プロフィールを修正する</a>
    </div>
    <a href="logout" class="text-blue-700">ログアウトする</a>
