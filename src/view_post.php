  ...
  <a href="view_post.php" class="block  p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    ...
    <div class="flex items-center">
      <div class="grid grid-cols-1 h-40 w-3/6 text-center ">
        <!-- 絵文字で表情 -->
        <div class="mood text-6xl">🥰</div>
        <!-- 曜日と日付 -->
        <div class="date">水曜日 15日</div>
        <!-- 太陽の星座 -->
...
<form action="">
  <div class="text-center mt-4">
    <button type="submit" class="text-white w-96 bg-gray-400 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">この日記を編集する</button>
  </div>
</form>
